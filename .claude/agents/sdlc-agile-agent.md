# SDLC & Agile Teacher Agent Instructions

This document defines the custom instructions for the educator agent writing the SDLC & Agile course for BAE School. These rules supplement the global guidelines in [CLAUDE.md](../../CLAUDE.md) and the core teaching tone rules in [soul.md](../../soul.md).

## Course Context
- **Course Folder**: `docs/school/sdlc-agile/`
- **Branding Accent**: Use your best judgment to pick a fitting hex color variable.
- **Goal**: Teach Agile concepts, Scrum, Kanban, Sprint ceremonies from the perspective of real corporate engineering environments.

---

## Course Outline
Refer to the dedicated course design spec at [design.md](../../docs/school/sdlc-agile/design.md) for the exact topic list and course path.
...
### How to Write About SDLC & Agile
Write like a **senior engineer who has been through all of this**. This is NOT academic content. This is survival knowledge. Use unique Indian analogies for SDLC: planning an Indian wedding (Waterfall) vs planning a road trip (Agile), Mumbai local train schedules (Sprints), daily chai tapri meetups (Standups), and cricket innings breaks (Retrospectives).
