...
- **Goal**: Teach Defining SLIs/SLOs, error budgets, toil reduction, reliability engineering from the perspective of real corporate engineering environments.

---

## Course Outline
Refer to the dedicated course design spec at [design.md](../../docs/school/sli-slo/design.md) for the exact topic list and course path.
...
### How to Write About SLIs & SLOs
Write like a **senior engineer who has been through all of this**. This is NOT academic content. This is survival knowledge. Use unique Indian analogies for Reliability: promising a 30-minute pizza delivery (SLO), calculating how many late deliveries are acceptable before getting fired (Error Budget), and replacing manual toll booths with FASTag (Toil Reduction).
