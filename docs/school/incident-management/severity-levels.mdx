...
A logistics startup had 200 alerts configured in PagerDuty. Every single one was set to "critical" and paged the entire engineering team simultaneously. A disk at 75% capacity? Critical page. A dashboard rendering 50ms slower than usual? Critical page. A real payment processing outage? Also critical page — but now everyone was fatigued and some engineers had stopped acknowledging alerts.

An SRE lead spent a week triaging and assigning proper severity levels. P0: complete service outage or data loss — wake the team immediately. P1: major functionality broken, significant user impact — page the IC. P2: degraded performance, workaround available — alert in Slack during business hours. P3: cosmetic issues, minor anomalies — file a ticket. The result was dramatic: P0/P1 pages dropped from 40/week to 5/week. Acknowledgement rates went to 98%. When a real P0 fired, engineers actually woke up energized to fix it because they hadn't been worn down by fake emergencies all week. Severity levels don't reduce problems — they tell you which problems deserve your adrenaline.

## 3. Real-World Analogy

![Real-World Analogy](./images/severity-levels/analogy.png)
